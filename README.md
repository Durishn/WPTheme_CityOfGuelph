...
## Testing
We don't have any tests or lints currently, but in the future merges into master may require passing automated tests for content, errors, warnings, and code style. Each test will be explained in more detail as it is added.
